...
<%@ include file="../include/header.jsp" %>
	...
	<main class="form-signin w-100 m-auto">
	  <form method="post" action='<c:url value="/member/changePwd"/>'>    
		...
		<div class="form-floating">
	      <input type="password" class="form-control" id="floatingPassword2" placeholder="새비밀번호" 
	      name="newPassword">
	      <label for="floatingPassword2">새 비밀번호</label>
	    </div>
	    <div class="form-floating">
	      <input type="password" class="form-control" id="floatingPassword3" placeholder="새비밀번호 확인"
